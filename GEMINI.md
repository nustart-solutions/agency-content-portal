...
**No Emoji Characters in Python Scripts**: Windows console encoding (cp1252) cannot handle emoji characters. Use plain text markers instead:
- Use `[OK]`, `[FAIL]`, `[WARN]`, `[INFO]` instead of ✅ ❌ ⚠️ ℹ️
- Use `[SUCCESS]` instead of 🎉
- This prevents `UnicodeEncodeError: 'charmap' codec can't encode character` errors
- Keep scripts compatible with Windows, macOS, and Linux
